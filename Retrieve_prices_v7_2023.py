...
start = pd.Timestamp('2023-01-01 00:00:00', tz='Europe/Brussels')
end   = pd.Timestamp('2024-01-01 00:00:00', tz='Europe/Brussels')
...
if len(DA) == len(datetime_hourly):
    ...
    print(f"Length mismatch: DA has {len(DA)} elements, datetime_hourly has {len(datetime_hourly)} elements \n")
